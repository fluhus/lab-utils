...
argp.add_argument('-r', type=float, default=1, help='Image height')
argp.add_argument('-c', type=float, default=1, help='Image width')
argp.add_argument('-rr', type=float, nargs='*', help='Height ratios')
argp.add_argument('-cc', type=float, nargs='*', help='Width ratios')
argp.add_argument('-d', type=int, default=300, help='DPI')
...
figsize = FIGSIZE * 0.7 * [width, height]
_, axs = plt.subplots(
    len(r),
    len(c),
    height_ratios=r,
